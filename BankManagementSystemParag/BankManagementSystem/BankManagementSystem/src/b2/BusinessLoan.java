...
public class BusinessLoan extends LoanAccount 
{
     ...
     BusinessLoan(int accountNumber, String accountHolderName, String accountType, double currentBalance,
	...
	int getYearsInBusiness() {
		return yearsInBusiness;
	}
	void setYearsInBusiness(int yearsInBusiness) {
		this.yearsInBusiness = yearsInBusiness;
	}
    //display
	 @Override
