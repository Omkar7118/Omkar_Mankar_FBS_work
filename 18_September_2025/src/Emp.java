...
class TestEmp{
	...
	{
		Emp e1=new Emp(1,"Adidya",25000);
		e1.calSal();
		Hrm h1=new Hrm(2,"Omkar",30000,5000);
		h1.display();
		SalesManager s1=new SalesManager(3,"Aditya",32000,4000,30);
		s1.display();
		Admin a1=new Admin(4,"Aditya",32000,3000);
		a1.display();
		AreaManager ar1=new AreaManager(5,"Aditya",32000,4000,30,"Pune");
		ar1.display();
	}
